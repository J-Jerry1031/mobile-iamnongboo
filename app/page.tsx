    ...
    <>
      <section className="px-5 pt-5">
        <div className="rounded-[2rem] bg-[#214b36] p-6 text-white shadow-xl shadow-green-900/20">
          <p className="text-sm text-[#d8e6cd]">
          ...
          <p className="mt-3 text-sm leading-6 text-[#edf3e8]">
            동탄 아이엠농부에서 매일 선별한 과일, 채소, 유기농 상품을
            모바일로 편하게 만나보세요.
          </p>

          <Link
            href="/products/market"
            className="mt-5 inline-flex rounded-full bg-[#f5d87a] px-5 py-3 text-sm font-black text-[#214b36] active:scale-[.98]"
          >
            오늘 상품 보기
          </Link>
        </div>
      ...
      <section className="px-5 pt-8">
        <div className="mb-4 flex items-end justify-between">
          ...
          <Link
            href="/products/market"
            className="text-sm font-bold text-[#7a6b4d]"
          >
            전체보기
          </Link>
        </div>
